...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "html,body{\n    max-width: 100%;\n    overflow-x: hidden;\n}\nhtml{\n    height:100%\n}\ndiv{\n    min-height: 100%;\n    min-width: 100%;\n    margin:0;\n}\nbody{\n    text-align: center;\n    display: flex;\n    flex-direction: column;\n    min-height: 100%;\n    background-color: rgb(242 240 235);\n    align-items: center;\n    font-size: 1rem;\n    margin:0;\n}\n#inputForm{\n    align-self: flex-end;\n    display: flex;\n    width:clamp(325px,95%,492px);\n    flex-direction: column;\n    justify-content: space-around;\n    bottom:1%;\n    border:1px solid black;\n    border-radius: .5rem;\n    background-color: rgb(213 233 226);\n    font-weight: bold;\n    overflow: auto;\n    overflow-x:hidden;\n    margin:auto auto .5rem auto;\n    padding-bottom: .5rem;\n    align-items: center;\n    font-size: 1rem;\n}\n#inputForm input{\n    border-radius: .5rem;\n    font-size:1.1rem;\n}\n#inputForm button{\n    background-color: rgb(0 117 74);\n    color:white;\n    border-radius: .5rem;\n    font-size:1.3rem;\n}\n#newPersonForm{\n    flex:1;\n    width:93%;\n    display: flex;\n    flex-direction: row;\n    justify-content: center;\n    border-bottom:1px grey solid;\n    margin-bottom: .5rem;\n    padding:.3rem;\n    align-items: center;\n    column-gap: 3%;\n}\n#nameInput{\n    width:clamp(5.5rem, 5.7rem, 12vw);\n}\ninput[type=\"number\"]{\n    width:13vw;\n} \n#addPerson-btn{\n    width:20%\n}\n#calculationForm{\n    display: flex;\n    flex-direction: row;\n    justify-content: center;\n    margin-bottom: .5rem;\n    border-bottom: 1px solid grey;\n    padding:.3rem;\n    align-items: center;\n    column-gap: 6%;\n}\n.personContainer{\n    display: grid;\n    grid-template-columns: repeat(4,1fr);\n    grid-column:1/5;\n    border-bottom: 1px solid grey;\n    align-content: center;\n    box-sizing: border-box;\n    padding:.2rem 0;\n    justify-items: center;\n}\n#container{\n    display: grid;\n    grid-template-columns: repeat(4,1fr);\n    grid-template-rows: 2rem;\n    grid-auto-flow: column;\n    row-gap: .3rem;\n    font-size:1rem;\n    padding:.2rem;\n    padding-top: 0;\n}\n#container-header{\n    grid-column: 1/5;\n    display: grid;\n    grid-template-columns: repeat(4,1fr);\n    text-decoration: underline;\n    background:rgb(0 98 65);\n    color:rgb(242 240 235);\n    border:1px solid grey;\n}\n#container-header div{\n    display: flex;\n    justify-content: center;\n    align-items: center;\n}\nimg{\n    max-width: 100%;\n    max-height: 100%;\n}\n.deleteButton{\n    border-radius:1rem;\n    background-color: rgb(248, 171, 148);\n    color:black;\n    width:75%;\n}\n\n#menu:active{\n        transform: scale(0.9);\n        background-color: rgb(0, 129, 81);\n}", "",{"version":3,"sources":["webpack://./src/styles/main.css"],"names":[],"mappings":"AAAA;IACI,eAAe;IACf,kBAAkB;AACtB;AACA;IACI;AACJ;AACA;IACI,gBAAgB;IAChB,eAAe;IACf,QAAQ;AACZ;AACA;IACI,kBAAkB;IAClB,aAAa;IACb,sBAAsB;IACtB,gBAAgB;IAChB,kCAAkC;IAClC,mBAAmB;IACnB,eAAe;IACf,QAAQ;AACZ;AACA;IACI,oBAAoB;IACpB,aAAa;IACb,4BAA4B;IAC5B,sBAAsB;IACtB,6BAA6B;IAC7B,SAAS;IACT,sBAAsB;IACtB,oBAAoB;IACpB,kCAAkC;IAClC,iBAAiB;IACjB,cAAc;IACd,iBAAiB;IACjB,2BAA2B;IAC3B,qBAAqB;IACrB,mBAAmB;IACnB,eAAe;AACnB;AACA;IACI,oBAAoB;IACpB,gBAAgB;AACpB;AACA;IACI,+BAA+B;IAC/B,WAAW;IACX,oBAAoB;IACpB,gBAAgB;AACpB;AACA;IACI,MAAM;IACN,SAAS;IACT,aAAa;IACb,mBAAmB;IACnB,uBAAuB;IACvB,4BAA4B;IAC5B,oBAAoB;IACpB,aAAa;IACb,mBAAmB;IACnB,cAAc;AAClB;AACA;IACI,iCAAiC;AACrC;AACA;IACI,UAAU;AACd;AACA;IACI;AACJ;AACA;IACI,aAAa;IACb,mBAAmB;IACnB,uBAAuB;IACvB,oBAAoB;IACpB,6BAA6B;IAC7B,aAAa;IACb,mBAAmB;IACnB,cAAc;AAClB;AACA;IACI,aAAa;IACb,oCAAoC;IACpC,eAAe;IACf,6BAA6B;IAC7B,qBAAqB;IACrB,sBAAsB;IACtB,eAAe;IACf,qBAAqB;AACzB;AACA;IACI,aAAa;IACb,oCAAoC;IACpC,wBAAwB;IACxB,sBAAsB;IACtB,cAAc;IACd,cAAc;IACd,aAAa;IACb,cAAc;AAClB;AACA;IACI,gBAAgB;IAChB,aAAa;IACb,oCAAoC;IACpC,0BAA0B;IAC1B,uBAAuB;IACvB,sBAAsB;IACtB,qBAAqB;AACzB;AACA;IACI,aAAa;IACb,uBAAuB;IACvB,mBAAmB;AACvB;AACA;IACI,eAAe;IACf,gBAAgB;AACpB;AACA;IACI,kBAAkB;IAClB,oCAAoC;IACpC,WAAW;IACX,SAAS;AACb;;AAEA;QACQ,qBAAqB;QACrB,iCAAiC;AACzC","sourcesContent":["html,body{\n    max-width: 100%;\n    overflow-x: hidden;\n}\nhtml{\n    height:100%\n}\ndiv{\n    min-height: 100%;\n    min-width: 100%;\n    margin:0;\n}\nbody{\n    text-align: center;\n    display: flex;\n    flex-direction: column;\n    min-height: 100%;\n    background-color: rgb(242 240 235);\n    align-items: center;\n    font-size: 1rem;\n    margin:0;\n}\n#inputForm{\n    align-self: flex-end;\n    display: flex;\n    width:clamp(325px,95%,492px);\n    flex-direction: column;\n    justify-content: space-around;\n    bottom:1%;\n    border:1px solid black;\n    border-radius: .5rem;\n    background-color: rgb(213 233 226);\n    font-weight: bold;\n    overflow: auto;\n    overflow-x:hidden;\n    margin:auto auto .5rem auto;\n    padding-bottom: .5rem;\n    align-items: center;\n    font-size: 1rem;\n}\n#inputForm input{\n    border-radius: .5rem;\n    font-size:1.1rem;\n}\n#inputForm button{\n    background-color: rgb(0 117 74);\n    color:white;\n    border-radius: .5rem;\n    font-size:1.3rem;\n}\n#newPersonForm{\n    flex:1;\n    width:93%;\n    display: flex;\n    flex-direction: row;\n    justify-content: center;\n    border-bottom:1px grey solid;\n    margin-bottom: .5rem;\n    padding:.3rem;\n    align-items: center;\n    column-gap: 3%;\n}\n#nameInput{\n    width:clamp(5.5rem, 5.7rem, 12vw);\n}\ninput[type=\"number\"]{\n    width:13vw;\n} \n#addPerson-btn{\n    width:20%\n}\n#calculationForm{\n    display: flex;\n    flex-direction: row;\n    justify-content: center;\n    margin-bottom: .5rem;\n    border-bottom: 1px solid grey;\n    padding:.3rem;\n    align-items: center;\n    column-gap: 6%;\n}\n.personContainer{\n    display: grid;\n    grid-template-columns: repeat(4,1fr);\n    grid-column:1/5;\n    border-bottom: 1px solid grey;\n    align-content: center;\n    box-sizing: border-box;\n    padding:.2rem 0;\n    justify-items: center;\n}\n#container{\n    display: grid;\n    grid-template-columns: repeat(4,1fr);\n    grid-template-rows: 2rem;\n    grid-auto-flow: column;\n    row-gap: .3rem;\n    font-size:1rem;\n    padding:.2rem;\n    padding-top: 0;\n}\n#container-header{\n    grid-column: 1/5;\n    display: grid;\n    grid-template-columns: repeat(4,1fr);\n    text-decoration: underline;\n    background:rgb(0 98 65);\n    color:rgb(242 240 235);\n    border:1px solid grey;\n}\n#container-header div{\n    display: flex;\n    justify-content: center;\n    align-items: center;\n}\nimg{\n    max-width: 100%;\n    max-height: 100%;\n}\n.deleteButton{\n    border-radius:1rem;\n    background-color: rgb(248, 171, 148);\n    color:black;\n    width:75%;\n}\n\n#menu:active{\n        transform: scale(0.9);\n        background-color: rgb(0, 129, 81);\n}"],"sourceRoot":""}]);
// Exports
...
/******/ })()
;
//# sourceMappingURL=bundled69faead98a8be1bb896.js.map